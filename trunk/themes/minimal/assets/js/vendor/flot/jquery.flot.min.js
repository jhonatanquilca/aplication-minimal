    ...
    Canvas.prototype.getTextLayer = function(classes) {
        ...
        if (layer == null) {
            if (this.textContainer == null) {
                this.textContainer = $("<div class='plot-text'></div>").css({position: "absolute", top: 0, left: 0, bottom: 0, right: 0, "font-size": "smaller", color: "#545454"}).insertAfter(this.element)
            }

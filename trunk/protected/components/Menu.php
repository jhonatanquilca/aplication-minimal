...
//                 'activeCssClass' => 'active',
            ...
            array('label' => '<i class="fa fa-pencil"></i>Administracion <b class="fa fa-plus dropdown-plus"></b>',
                ...
                'items' => array(
                    array('label' => '<i class="fa fa-caret-right"></i>Personas', 
                        'url' => array('/persona/persona/'), 
                        'access' => 'action_llamadaReporte_admin', 
                        'active_rules' => array('module' => 'persona', 'controller' => 'persona'),),
                    array('label' => '<i class="fa fa-caret-right"></i>Crear Persona', 
                        'url' => array('/asd/asd/asd'), 
                        'access' => 'action_llamadaReporte_admin', 
                        'active_rules' => array('module' => 'asd', 'controller' => 'as'),),
...
//            array('label' => '<i class="fa fa-pencil"></i>Menu sub menu <b class="fa fa-plus dropdown-plus"></b>',
//                'url' => '#',
//                'itemOptions' => array('class' => 'dropdown'),
//                'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => 'dropdown',),
//                'items' => array(
//                    array('label' => '<i class="fa fa-caret-right"></i>Personas', 'url' => array('/modulo/controller/'), 'access' => 'action_llamadaReporte_admin', 'active_rules' => array('module' => 'llamadas', 'controller' => 'llamadaReporte'),),
//                ),
//            ),
